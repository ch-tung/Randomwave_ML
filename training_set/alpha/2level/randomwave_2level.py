...
#### Scattering function ####
def scatter_grid(rho, cl, qq, scale=1, box_size=2):
    """
    ...
    rho_sq = rho_bi_zoom**2
    rho_bi = np.zeros_like(rho_sq)  # Density = 0 or 1
    rho_bi[rho_sq > cl] = 1  # Clipped to cl
