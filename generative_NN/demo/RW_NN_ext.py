...
# alpha_list = np.arange(10)/20 # using the original training set
alpha_list = np.arange(10)/10 # using the extended training set
...
export_path_aug = './saved_model/test/SQ_Gen_NN/'
model_name_aug = 'test_bg_model_aug_ext'
export_name_aug = export_path_aug + model_name_aug

export_path_decoder = './saved_model/test/SQ_Gen_NN/'
model_name_decoder = 'test_bg_model_decoder_ext'
export_name_decoder = export_path_decoder + model_name_decoder
